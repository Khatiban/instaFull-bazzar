 ...
 */
public class MyDatabaseHelper_url extends SQLiteOpenHelper {
    public static final String DB_NAME = "data_Url.db";
    public static final String TBL_NAME = "Data_Url";

    public MyDatabaseHelper_url(Context context) {
