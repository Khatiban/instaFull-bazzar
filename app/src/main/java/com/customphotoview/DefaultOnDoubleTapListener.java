...
public class DefaultOnDoubleTapListener implements OnDoubleTapListener {
    ...
    public boolean onSingleTapConfirmed(MotionEvent e) {
        ...
        if (ViewImageActivity.act != null) {
            ViewImageActivity.act.toggleFullView();
        }
        if (ViewImageActivityPost.act != null) {
            ViewImageActivityPost.act.toggleFullView();
        }
        if (ViewImageActivityStory.act != null) {
            ViewImageActivityStory.act.toggleFullView();
        }
