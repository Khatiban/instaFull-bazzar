...
public class MySavedImagesAdapter_Story extends Adapter<MySavedImagesAdapter_Story.MyViewHolder> {
    Context f13c;
    int f14h;
    ...
    public MySavedImagesAdapter_Story(Context c, List<DownloadModel_Story> listItems) {
        ...
        this.params = new LayoutParams((f15w / 3) - 4, (f15w / 2) - 4);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        DownloadModel_Story model = (DownloadModel_Story) listItems.get(position);
